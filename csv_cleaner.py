...
# with open('/home/zainab/social_network-sf10-CsvComposite-LongDateFormatter/dynamic/post_0_0.csv', 'r') as infile, open('/home/zainab/benchmarking/sf-10/dynamic/post_0_0.csv', 'w', newline='') as outfile:
...
# Open the input and output files
with open('/home/zainab/social_network-sf10-CsvComposite-LongDateFormatter/dynamic/post_isLocatedIn_place_0_0.csv', 'r') as infile, open('/home/zainab/benchmarking/sf-10/dynamic/post_isLocatedIn_place_0_0.csv', 'w', newline='') as outfile:
    reader = csv.reader(infile, delimiter='|')
    writer = csv.writer(outfile, delimiter=',')
    count = 0
