...
'/home/zainab/benchmarking/sf-1/dynamic/comment_0_0.csv', true, true);

SELECT load_labels_from_file('benchmark', 'Person',
'/home/zainab/benchmarking/sf-1/dynamic/person_0_0.csv', true, true);

SELECT load_labels_from_file('benchmark', 'Forum',
'/home/zainab/benchmarking/sf-1/dynamic/forum_0_0.csv', true, true);

SELECT load_labels_from_file('benchmark', 'Post',
'/home/zainab/benchmarking/sf-1/dynamic/post_0_0.csv', true, true);


SELECT load_edges_from_file('benchmark', 'HAS_CREATOR',
'/home/zainab/benchmarking/sf-1/dynamic/comment_hasCreator_person_0_0.csv', true);

SELECT load_edges_from_file('benchmark', 'HAS_TAG',
'/home/zainab/benchmarking/sf-1/dynamic/comment_hasTag_tag_0_0.csv', true);


SELECT load_edges_from_file('benchmark', 'IS_LOCATED_IN',
'/home/zainab/benchmarking/sf-1/dynamic/comment_isLocatedIn_place_0_0.csv', true);


SELECT load_edges_from_file('benchmark', 'REPLY_OF',
'/home/zainab/benchmarking/sf-1/dynamic/comment_replyOf_comment_0_0.csv', true);


SELECT load_edges_from_file('benchmark', 'REPLY_OF',
'/home/zainab/benchmarking/sf-1/dynamic/comment_replyOf_post_0_0.csv', true);

SELECT load_edges_from_file('benchmark', 'CONTAINER_OF',
'/home/zainab/benchmarking/sf-1/dynamic/forum_containerOf_post_0_0.csv', true);


SELECT load_edges_from_file('benchmark', 'HAS_MEMBER',
'/home/zainab/benchmarking/sf-1/dynamic/forum_hasMember_person_0_0.csv', true);


SELECT load_edges_from_file('benchmark', 'HAS_MODERATOR',
'/home/zainab/benchmarking/sf-1/dynamic/forum_hasModerator_person_0_0.csv', true);


SELECT load_edges_from_file('benchmark', 'HAS_TAG',
'/home/zainab/benchmarking/sf-1/dynamic/forum_hasTag_tag_0_0.csv', true);


SELECT load_edges_from_file('benchmark', 'HAS_INTEREST',
'/home/zainab/benchmarking/sf-1/dynamic/person_hasInterest_tag_0_0.csv', true);


SELECT load_edges_from_file('benchmark', 'IS_LOCATED_IN',
'/home/zainab/benchmarking/sf-1/dynamic/person_isLocatedIn_place_0_0.csv', true);


SELECT load_edges_from_file('benchmark', 'KNOWS',
'/home/zainab/benchmarking/sf-1/dynamic/person_knows_person_0_0.csv', true);


SELECT load_edges_from_file('benchmark', 'LIKES',
'/home/zainab/benchmarking/sf-1/dynamic/person_likes_comment_0_0.csv', true);


SELECT load_edges_from_file('benchmark', 'STUDY_AT',
'/home/zainab/benchmarking/sf-1/dynamic/person_studyAt_organisation_0_0.csv', true);


SELECT load_edges_from_file('benchmark', 'WORK_AT',
'/home/zainab/benchmarking/sf-1/dynamic/person_workAt_organisation_0_0.csv', true);


SELECT load_edges_from_file('benchmark', 'HAS_CREATOR',
'/home/zainab/benchmarking/sf-1/dynamic/post_hasCreator_person_0_0.csv', true);


SELECT load_edges_from_file('benchmark', 'HAS_TAG',
'/home/zainab/benchmarking/sf-1/dynamic/post_hasTag_tag_0_0.csv', true);


SELECT load_edges_from_file('benchmark', 'IS_LOCATED_IN',
'/home/zainab/benchmarking/sf-1/dynamic/post_isLocatedIn_place_0_0.csv', true);


SELECT load_labels_from_file('benchmark', 'Organisation',
'/home/zainab/benchmarking/sf-1/static/organisation_0_0.csv', true, true);

SELECT load_labels_from_file('benchmark', 'Place',
'/home/zainab/benchmarking/sf-1/static/place_0_0.csv', true, true);

SELECT load_labels_from_file('benchmark', 'Tag',
'/home/zainab/benchmarking/sf-1/static/tag_0_0.csv', true, true);

SELECT load_labels_from_file('benchmark', 'Tagclass',
'/home/zainab/benchmarking/sf-1/static/tagclass_0_0.csv', true, true);


SELECT load_edges_from_file('benchmark', 'IS_LOCATED_IN',
'/home/zainab/benchmarking/sf-1/static/organisation_isLocatedIn_place_0_0.csv', true);

SELECT load_edges_from_file('benchmark', 'IS_PART_OF',
'/home/zainab/benchmarking/sf-1/static/place_isPartOf_place_0_0.csv', true);


SELECT load_edges_from_file('benchmark', 'IS_SUBCLASS_OF',
'/home/zainab/benchmarking/sf-1/static/tagclass_isSubclassOf_tagclass_0_0.csv', true);


SELECT load_edges_from_file('benchmark', 'HAS_TYPE',
'/home/zainab/benchmarking/sf-1/static/tag_hasType_tagclass_0_0.csv', true);
