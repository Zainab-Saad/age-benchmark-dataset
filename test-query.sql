...
-- issue is with using VLE and WHERE condition doesnt return any rows
-- Q5
SELECT 'SELECT * FROM cypher(''benchmark'', 
$$
MATCH (person:Person { id: 6597069766735 })-[:KNOWS]-(friend)
WHERE
    NOT person=friend
...
$$) AS (result1 agtype);' from generate_series(1,10) \gexec
